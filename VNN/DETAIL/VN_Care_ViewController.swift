...
class VN_Care_ViewController: UIViewController {
    ...
    func reset() {
        ...
        (self.ownList[3] as! NSMutableDictionary)["data"] = ""
        
        (self.ownList[3] as! NSMutableDictionary)["list"] = []
        ...
        (self.ownList[11] as! NSMutableDictionary)["data"] = ""
    ...
    func fillInDealer(dealer: NSDictionary) {
        ...
        (self.dataList()[6] as! NSMutableDictionary)["data"] = dealer.getValueFromKey("phonenumber")
    ...
    @IBAction func didRequestUpdateAgency() {
        ...
        let agencyInfo = ["agencyinfo":["address":(self.dataList()[4] as! NSMutableDictionary)["data"],
                                        "agency_code": (self.dataList()[3] as! NSMutableDictionary)["data"],
                                        "agency_id": "",
                                        "agency_level": "",
                                        "agency_name": (self.dataList()[5] as! NSMutableDictionary)["data"],
                                        "agency_type": 1,
                                        "city_id":self.getID(type: 1),
